...
export const experimentConfig = {
  ...
  effects: [
    { id: 'blink', label: 'Blink', definition: 'Element rapidly appears and disappears repeatedly.', icon: 'lucide:scan-eye' },
    { id: 'fade', label: 'Fade', definition: 'Smooth transition between visible and invisible states.', icon: 'lucide:blend' },
    { id: 'glow', label: 'Glow', definition: 'A soft light radiates from the edges of the element.', icon: 'lucide:sun' },
    { id: 'fillColor', label: 'Fill color', definition: 'Color slowly shifts from one hue to another.', icon: 'lucide:paint-bucket' },
    { id: 'desaturate', label: 'Desaturate', definition: 'Colors lose intensity, moving toward grayscale.', icon: 'lucide:circle-off' },
    { id: 'pulse', label: 'Pulse', definition: 'Element subtly expands and contracts in rhythm.', icon: 'lucide:activity' },
    { id: 'flip', label: 'Flip', definition: 'Element rotates as if turned along an axis.', icon: 'lucide:flip-horizontal-2' },
    { id: 'shake', label: 'Shake', definition: 'Rapid micro-movements create vibration.', icon: 'lucide:vibrate' },
    { id: 'scale', label: 'Scale', definition: 'Element smoothly enlarges or reduces in size.', icon: 'lucide:move-diagonal-2' },
    { id: 'shatter', label: 'Shatter', definition: 'Element visually breaks into pieces that disperse.', icon: 'lucide:sparkles' },
  ],
